                ...
                <Flickity class="gap-[30px]" options={flickityOptions}>
                    {[1, 2, 3, 4].map((i) => (
                        ...
                        <div class="absolute overflow-hidden group mr-[30px]">
                            ...
                            {/* bottom detail */}
                            <div class="absolute bottom-0 h-[100px] left-0 right-0 bg-gradient-to-t from-black rounded-bl-[28px] rounded-br-[28px] flex justify-between items-center px-7 h-[130px]">
                                <div>
